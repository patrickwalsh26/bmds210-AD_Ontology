...
**Command:** `python3 vignette_eval.py --suite all`
...
**Command:** `python3 realistic_simulation.py --json docs/cohort_simulation_results.json`
...
6. **Run `python3 evaluation_suite.py`** before submission to refresh `docs/evaluation_results_summary.md`.
...
```bash
python3 vignette_eval.py --suite all
python3 vignette_eval.py --suite dev --baseline condition-blind
python3 realistic_simulation.py --json docs/cohort_simulation_results.json
python3 realistic_simulation.py --degrade-encoding
python3 coverage_analysis.py
python3 track3_evaluation.py
python3 extraction_evaluation.py   # requires API key
python3 evaluation_suite.py
