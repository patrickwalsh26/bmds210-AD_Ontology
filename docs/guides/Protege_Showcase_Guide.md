...
| **C. Backup slides** | 0 min live | PNG hierarchy in `docs/presentation/presentation_figures/ontology_class_hierarchy.png` | No Protégé on laptop or Java issues |
...
| `data/populated/ado_jane_doe_001.owl` | **Best for demo** — Jane Doe, 9 preferences from JSON pipeline |
...
**Open:** `data/populated/ado_jane_doe_001.owl`
...
**Combined 5-minute segment:** Protégé steps 1–2 (2 min) → switch to terminal → `python scripts/demo.py --scenario 1` (90 s).
...
- [ ] Backup PNG: `docs/presentation/presentation_figures/ontology_class_hierarchy.png`
...
| Populated file missing | `python -m ado.preference_input --example` |
...
Output: `docs/presentation/presentation_figures/ontology_class_hierarchy.png` — optional insert on slide 5.
