...
## Track 2 results (run 2026-05-30, `python evaluation/extraction_evaluation.py`, live API, `claude-opus-4-7`)
...
- **Inter-annotator agreement** (two human annotators on this same text set) is to be filled
  in by the team using the blind sheet: `python evaluation/extraction_evaluation.py --sheet`.

## Track 3 results (run 2026-05-30, `python evaluation/track3_evaluation.py`)
...
independent rating is available via `python evaluation/track3_evaluation.py --sheet`.
...
Run: `python evaluation/vignette_eval.py --suite all`
...
Run: `python evaluation/coverage_analysis.py`
...
Run: `python evaluation/eval_inter_annotator.py`

Full summary: `python evaluation/evaluation_suite.py` writes `docs/evaluation/evaluation_results_summary.md`
...
- Honest interpretation: `docs/evaluation/Honest_Evaluation_Report.md`.
