...
**Runtime:** ~9 minutes + ~2 minutes Q&A · **17 slides recommended** · Figures in `docs/presentation/presentation_figures/` (300 DPI)

**Regenerate deck:** `./scripts/build_presentation_assets.sh` · Placement: `docs/presentation/PPT_Figures_Guide.md`
...
**OPTIONAL LIVE — Protégé:** `data/populated/ado_jane_doe_001.owl` · see `docs/guides/Protege_Showcase_Guide.md`.
...
**SAY:** Read bullets. Repo. Questions. Optional live demo: `python scripts/demo.py --scenario 1`.
