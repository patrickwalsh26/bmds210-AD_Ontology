...
from ado.gemini_extraction import (
    DEFAULT_MODEL,
    extract_preferences,
    get_gemini_client,
    to_patient_json,
)
from ado.llm_direct_reasoning import PromptVariant, reason_directly, score_direct_decision


ROOT = Path(__file__).resolve().parents[1]
CANONICAL_AD_PATH = ROOT / "data" / "populated" / "jane_doe_canonical_ad.txt"
GOLD_JSON_PATH = ROOT / "data" / "populated" / "example_input.json"
