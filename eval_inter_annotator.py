...
Annotators fill JSON files (see gold_annotations/). This script computes Cohen's kappa
...
ANNOT_DIR = ROOT / "gold_annotations"
STATEMENTS = ROOT / "gold_annotations" / "statements.json"
