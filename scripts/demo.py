...
Usage:
    python scripts/demo.py                  # walk through all 5 demo scenarios
    python scripts/demo.py --scenario 3     # just one scenario (1-indexed)
    python scripts/demo.py --pause          # pause between scenarios (for live demo)
"""
...
from ado.query_evaluation import find_matching_preferences, evaluate_vignette


from ado.paths import DEFAULT_POPULATED_OWL as OWL_PATH
...
def run_llm_pipeline_scenario(idx, total, scenario, pause):
    ...
    if not os.environ.get("ANTHROPIC_API_KEY"):
        extraction_failure = (
            ...
            "then re-run `python scripts/demo.py --scenario 6`."
        )
    else:
        try:
    ...
    if extraction_failure:
        ...
        out_path = POPULATED_DIR / "ado_demo_llm_001.owl"
