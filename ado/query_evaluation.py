...
Usage:
    python -m ado.query_evaluation                        # Run against example patient
    python -m ado.query_evaluation --owl path/to/file.owl # Run against a specific populated ontology
"""
...
def main():
    ...
    parser.add_argument("--owl", type=str,
                        default="data/populated/ado_jane_doe_001.owl",  # use ado.paths.DEFAULT_POPULATED_OWL in code,
