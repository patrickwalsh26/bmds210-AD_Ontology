...
Usage:
    python -m ado.preference_input --interactive          # CLI questionnaire
    python -m ado.preference_input --json input.json      # Load from JSON file
    python -m ado.preference_input --example              # Generate example JSON + populate ontology
"""
...
from ado.paths import OWL_FILE, POPULATED_DIR as OUTPUT_DIR
